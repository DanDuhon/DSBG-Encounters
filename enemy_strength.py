...
try:
    ...
    if "Armorer Dennis" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "Fencer Sharron" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "Invader Brylex" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "Kirk, Knight of Thorns" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "Longfinger Kirk" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "Maldron the Assassin" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "Maneater Mildred" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "Marvelous Chester" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "Melinda the Butcher" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "Oliver the Collector" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "Paladin Leeroy" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "Xanthous King Jeremiah" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "Hungry Mimic" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "Voracious Mimic" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "Old Dragonslayer" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "Asylum Demon" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "Boreal Outrider Knight" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "Winged Knight" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "Black Knight" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "Heavy Knight" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "Titanite Demon" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "Gargoyle" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "Smelter Demon" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "The Pursuer" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "Crossbreed Priscilla" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "Gravelord Nito" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "Great Grey Wolf Sif" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "Dragon Slayer Ornstein" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
        bleedProc["Dragon Slayer Ornstein1"] = (sum([enemy.damagingAttacks[tier] * enemy.numberOfModels for enemy in enemies if "Dragon Slayer Ornstein" in enemy.name]) / sum([enemy.totalAttacks[tier] * enemy.numberOfModels for enemy in enemies if "Dragon Slayer Ornstein" in enemy.name])) * 0.721657509146666 * 1 # Mean reach and arc attack mods for Dragon Slayer Ornstein
        bleedProc["Dragon Slayer Ornstein2"] = (sum([enemy.damagingAttacks[tier] * enemy.numberOfModels for enemy in enemies if "Dragon Slayer Ornstein" in enemy.name]) / sum([enemy.totalAttacks[tier] * enemy.numberOfModels for enemy in enemies if "Dragon Slayer Ornstein" in enemy.name])) * 0.721657509146666 * 1.1 # Mean reach and arc attack mods for Dragon Slayer Ornstein
        bleedProc["Dragon Slayer Ornstein3"] = (sum([enemy.damagingAttacks[tier] * enemy.numberOfModels for enemy in enemies if "Dragon Slayer Ornstein" in enemy.name]) / sum([enemy.totalAttacks[tier] * enemy.numberOfModels for enemy in enemies if "Dragon Slayer Ornstein" in enemy.name])) * 0.721657509146666 * 1.2625 # Mean reach and arc attack mods for Dragon Slayer Ornstein
        bleedProc["Dragon Slayer Ornstein4"] = (sum([enemy.damagingAttacks[tier] * enemy.numberOfModels for enemy in enemies if "Dragon Slayer Ornstein" in enemy.name]) / sum([enemy.totalAttacks[tier] * enemy.numberOfModels for enemy in enemies if "Dragon Slayer Ornstein" in enemy.name])) * 0.721657509146666 * 1.4875 # Mean reach and arc attack mods for Dragon Slayer Ornstein
    if "Executioner Smough" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
        bleedProc["Executioner Smough1"] = (sum([enemy.damagingAttacks[tier] * enemy.numberOfModels for enemy in enemies if "Executioner Smough" in enemy.name]) / sum([enemy.totalAttacks[tier] * enemy.numberOfModels for enemy in enemies if "Executioner Smough" in enemy.name])) * 0.524358974341795 * 1 # Mean reach and arc attack mods for Executioner Smough
        bleedProc["Executioner Smough2"] = (sum([enemy.damagingAttacks[tier] * enemy.numberOfModels for enemy in enemies if "Executioner Smough" in enemy.name]) / sum([enemy.totalAttacks[tier] * enemy.numberOfModels for enemy in enemies if "Executioner Smough" in enemy.name])) * 0.524358974341795 * 1.3375 # Mean reach and arc attack mods for Executioner Smough
        bleedProc["Executioner Smough3"] = (sum([enemy.damagingAttacks[tier] * enemy.numberOfModels for enemy in enemies if "Executioner Smough" in enemy.name]) / sum([enemy.totalAttacks[tier] * enemy.numberOfModels for enemy in enemies if "Executioner Smough" in enemy.name])) * 0.524358974341795 * 1.86015625 # Mean reach and arc attack mods for Executioner Smough
        bleedProc["Executioner Smough4"] = (sum([enemy.damagingAttacks[tier] * enemy.numberOfModels for enemy in enemies if "Executioner Smough" in enemy.name]) / sum([enemy.totalAttacks[tier] * enemy.numberOfModels for enemy in enemies if "Executioner Smough" in enemy.name])) * 0.524358974341795 * 2.56796875 # Mean reach and arc attack mods for Executioner Smough
    if "Dancer of the Boreal Valley" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "Artorias" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "Sir Alonne" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "Stray Demon" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "Manus, Father of the Abyss" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "The Four Kings" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "The Last Giant" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "Guardian Dragon" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "Gaping Dragon" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "Vordt of the Boreal Valley" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "Black Dragon Kalameet" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "Old Iron King" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
    ...
    if "Executioner's Chariot" in set([enemy.name[:enemy.name.index(" -") if " -" in enemy.name else enemy.name.index(" (") if " (" in enemy.name else len(enemy.name)] for enemy in enemies]):
