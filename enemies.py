...
ngpc = []
for x in range(1, 5):
    ngpc += filterfalse(lambda c: (len(c) != len(set([a[:-1] for a in c])) or ("effect1" in c and "effect2" in c) or "repeat" not in c), combinations(newGamePlusMods, x))
...
# Enemy(id=10, name="Falchion Skeleton", expansion="Executioner Chariot", enemyType="regular", numberOfModels=2, health=1, armor=1, resist=1, iconForEffects=[0], attacks=[3], attackType=["physical"], attackEffect=[{"bleed",}], dodge=1, move=[2], attackRange=[0], difficultyTiers={1: {"toughness": 37664, "difficulty": {1: 81.37, 2: 81.37, 3: 81.37, 4: 81.37}}, 2: {"toughness": 42968, "difficulty": {1: 24.8, 2: 24.8, 3: 24.8, 4: 24.8}}, 3: {"toughness": 88396, "difficulty": {1: 66.76, 2: 66.76, 3: 66.76, 4: 66.76}}})
...
# Enemy(name="Guardian Dragon - Fiery Breath", expansion="Guardian Dragon", enemyType="mega boss", numberOfModels=1, health=44, armor=3, resist=3, iconForEffects=[0], attacks=[5], attackType=["magic"], nodesAttacked=[gdAoeAverage[0]], move=[0], attackRange=[0], dodge=1, weakArcs=0, skipDefense=True, aoe=True)
...
Enemy(name="Executioner's Chariot - Death Race", expansion="Executioner Chariot", enemyType="mega boss", aoe=True, numberOfModels=1, health=24, armor=3, resist=3, iconForEffects=[0], attacks=[7], attackType=["physical"], nodesAttacked=[5], move=[0], attackRange=[1], dodge=1, skipDefense=True)
