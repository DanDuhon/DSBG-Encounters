...
# Enemy(id=10, name="Falchion Skeleton", expansion="Executioner Chariot", enemyType="regular", numberOfModels=2, health=1, armor=1, resist=1, iconForEffects=[0], attacks=[3], attackType=["physical"], attackEffect=[{"bleed",}], dodge=1, move=[2], attackRange=[0], difficultyTiers={1: {"toughness": 37664, "difficulty": {1: 28.07, 2: 28.07, 3: 28.07, 4: 28.07}}, 2: {"toughness": 42968, "difficulty": {1: 4.98, 2: 4.98, 3: 4.98, 4: 4.98}}, 3: {"toughness": 88396, "difficulty": {1: 11.24, 2: 11.24, 3: 11.24, 4: 11.24}}})
...
# Enemy(id=38, name="Kirk, Knight of Thorns", expansion="Phantoms", enemyType="invader", numberOfModels=1, health=20, armor=0, resist=0, attacks=[0], attackType=["magic"], iconForEffects=[0], dodge=0, move=[0], attackRange=[0], difficultyTiers={1: {"toughness": 4599, "difficulty": {1: 372.14, 2: 384.41, 3: 396.68, 4: 411.79}}, 2: {"toughness": 6715, "difficulty": {1: 61.33, 2: 63.32, 3: 65.31, 4: 67.76}}, 3: {"toughness": 15341, "difficulty": {1: 128.24, 2: 132.07, 3: 135.9, 4: 140.61}}})
# Enemy(id=39, name="Longfinger Kirk", expansion="Phantoms", enemyType="invader", numberOfModels=1, health=20, armor=0, resist=0, attacks=[0], attackType=["magic"], iconForEffects=[0], dodge=0, move=[0], attackRange=[0], difficultyTiers={1: {"toughness": 1455, "difficulty": {1: 3636.21, 2: 3721.51, 3: 3806.81, 4: 3911.8}}, 2: {"toughness": 1919, "difficulty": {1: 767.52, 2: 785.43, 3: 803.35, 4: 825.4}}, 3: {"toughness": 6851, "difficulty": {1: 1358.46, 2: 1387.29, 3: 1416.11, 4: 1451.59}}})
...
# Enemy(id=42, name="Marvelous Chester", expansion="Phantoms", enemyType="invader", numberOfModels=1, health=20, armor=0, resist=0, attacks=[0], attackType=["magic"], iconForEffects=[0], dodge=0, move=[0], attackRange=[0], difficultyTiers={1: {"toughness": 1874, "difficulty": {1: 2482.71, 2: 2499.82, 3: 2516.92, 4: 2537.97}}, 2: {"toughness": 3216, "difficulty": {1: 342.77, 2: 345.38, 3: 348, 4: 351.22}}, 3: {"toughness": 9666, "difficulty": {1: 654.34, 2: 660.29, 3: 666.23, 4: 673.55}}})
...
# Enemy(id=46, name="Xanthous King Jeremiah", expansion="Phantoms", enemyType="invader", numberOfModels=1, health=20, armor=0, resist=0, attacks=[0], attackType=["magic"], iconForEffects=[0], dodge=0, move=[0], attackRange=[0], difficultyTiers={1: {"toughness": 6038.5, "difficulty": {1: 493.49, 2: 524.55, 3: 555.61, 4: 593.84}}, 2: {"toughness": 11494.5, "difficulty": {1: 78.49, 2: 83.38, 3: 88.28, 4: 94.31}}, 3: {"toughness": 19651, "difficulty": {1: 101.7, 2: 107.95, 3: 114.2, 4: 121.9}}})
