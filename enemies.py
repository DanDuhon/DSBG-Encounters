...
class Enemy:
    def __init__(self, name, expansion, enemyType, numberOfModels, health, armor, resist, iconForEffects, attacks, attackType, dodge, move, attackRange, id=None, repeat=0, nodeAttack=[], nodesAttacked=[], attackEffect=[], weakArcs=None, windup=False, moveIndex=None, skipDefense=False, difficultyTiers={}, moveAttack=[], modified=False, comboSet=frozenset(), aoe=False, invisibility=False, ambush=False) -> None:
