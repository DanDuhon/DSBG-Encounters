...
Enemy(name="Gargoyle - Flying Tail Whip", expansion="Dark Souls the Board Game", enemyType="main boss", numberOfModels=1, health=26, armor=2, resist=1, attacks=[6], attackType=["physical"], nodesAttacked=[10], dodge=1, move=[1], attackRange=[1])
Enemy(name="Gargoyle - Swooping Cleave", expansion="Dark Souls the Board Game", enemyType="main boss", numberOfModels=1, health=26, armor=2, resist=1, attacks=[6], attackType=["physical"], nodeAttack=[True], dodge=2, move=[2], attackRange=[1])
Enemy(name="Gargoyle - Aerial Electric Breath", expansion="Dark Souls the Board Game", enemyType="main boss", numberOfModels=1, health=26, armor=2, resist=1, attacks=[5], attackType=["magic"], nodesAttacked=[6], dodge=2, move=[0], attackRange=[2])
Enemy(name="Smelter Demon - Double Sweep", expansion="Iron Keep", enemyType="main boss", numberOfModels=1, health=22, armor=4, resist=3, attacks=[6,0,6,0], attackType=["physical", "physical", "physical", "physica"], nodesAttacked=[7], dodge=1, move=[0,-1,0,-1], attackRange=[1,1,1,1])
Enemy(name="Smelter Demon - Overhead Chop", expansion="Iron Keep", enemyType="main boss", numberOfModels=1, health=22, armor=4, resist=3, attacks=[6], attackType=["physical"], nodeAttack=[True], attackEffect=["stagger"], dodge=2, move=[1], attackRange=[1])
Enemy(name="Smelter Demon - Fiery Blast", expansion="Iron Keep", enemyType="main boss", numberOfModels=1, health=22, armor=4, resist=3, attacks=[5], attackType=["magic"], nodesAttacked=[12], dodge=2, move=[0], attackRange=[1])
Enemy(name="Smelter Demon - Leaping Impalement Strike", expansion="Iron Keep", enemyType="main boss", numberOfModels=1, health=22, armor=4, resist=3, attacks=[4,4], attackType=["physical", "physical"], nodeAttack=[True, False], dodge=2, move=[4,0], attackRange=[0,1])
...
Enemy(name="Smelter Demon - Lunging Strike", expansion="Iron Keep", enemyType="main boss", numberOfModels=1, health=22, armor=4, resist=3, attacks=[0,0,7], attackType=["physical"], dodge=1, move=[-1,2,0], attackRange=[1,1,1])
Enemy(name="Smelter Demon - Flaming Impalement Strike", expansion="Iron Keep", enemyType="main boss", numberOfModels=1, health=22, armor=4, resist=3, attacks=[4,4], attackType=["physical", "magic"], nodeAttack=[True, True], dodge=2, move=[4,0], attackRange=[1,1])
Enemy(name="Smelter Demon - Fiery Explosion", expansion="Iron Keep", enemyType="main boss", numberOfModels=1, health=22, armor=4, resist=3, attacks=[6], attackType=["magic"], nodesAttacked=[12], dodge=2, move=[0], attackRange=[1])
Enemy(name="Smelter Demon - Flaming Double Sweep", expansion="Iron Keep", enemyType="main boss", numberOfModels=1, health=22, armor=4, resist=3, attacks=[6,0,6,0], attackType=["magic", "magic", "magic", "magic"], nodesAttacked=[7,0,7,0], dodge=1, move=[0,-1,0,-1], attackRange=[1,1,1,1])
...
Enemy(name="Smelter Demon - Flaming Overhead Chop", expansion="Iron Keep", enemyType="main boss", numberOfModels=1, health=22, armor=4, resist=3, attacks=[6], attackType=["magic"], nodeAttack=[True], attackEffect=["stagger"], dodge=2, move=[1], attackRange=[2])
...
Enemy(name="Smelter Demon - Flaming Lunging Strike", expansion="Iron Keep", enemyType="main boss", numberOfModels=1, health=22, armor=4, resist=3, attacks=[0,0,7], attackType=["magic"], dodge=1, move=[-1,2,0], attackRange=[2,2,2])
...
Enemy(name="The Pursuer - Stabbing Strike", expansion="Explorers", enemyType="main boss", numberOfModels=1, health=28, armor=3, resist=2, attacks=[5], attackType=["physical"], dodge=1, move=[1], attackRange=[1])
Enemy(name="The Pursuer - Rising Blade Swing", expansion="Explorers", enemyType="main boss", numberOfModels=1, health=28, armor=3, resist=2, attacks=[5], attackType=["physical"], nodesAttacked=[4], dodge=2, move=[0], attackRange=[1])
...
Enemy(name="The Pursuer - Wide Blade Swing (heat up)", expansion="Explorers", enemyType="main boss", numberOfModels=1, health=28, armor=3, resist=2, attacks=[5], attackType=["physical"], nodesAttacked=[10], dodge=0, move=[1], attackRange=[1])
Enemy(name="The Pursuer - Wide Blade Swing (heat up)", expansion="Explorers", enemyType="main boss", numberOfModels=1, health=28, armor=3, resist=2, attacks=[5], attackType=["physical"], nodesAttacked=[10], dodge=0, move=[1], attackRange=[1])
Enemy(name="The Pursuer - Wide Blade Swing (heat up)", expansion="Explorers", enemyType="main boss", numberOfModels=1, health=28, armor=3, resist=2, attacks=[5], attackType=["physical"], nodesAttacked=[10], dodge=0, move=[1], attackRange=[1])
Enemy(name="The Pursuer - Stabbing Strike (heat up)", expansion="Explorers", enemyType="main boss", numberOfModels=1, health=28, armor=3, resist=2, attacks=[6], attackType=["physical"], dodge=1, move=[1], attackRange=[1])
Enemy(name="The Pursuer - Stabbing Strike (heat up)", expansion="Explorers", enemyType="main boss", numberOfModels=1, health=28, armor=3, resist=2, attacks=[6], attackType=["physical"], dodge=1, move=[1], attackRange=[1])
Enemy(name="The Pursuer - Rising Blade Swing (heat up)", expansion="Explorers", enemyType="main boss", numberOfModels=1, health=28, armor=3, resist=2, attacks=[6], attackType=["physical"], nodesAttacked=[4], dodge=2, move=[0], attackRange=[1])
Enemy(name="The Pursuer - Overhead Cleave (heat up)", expansion="Explorers", enemyType="main boss", numberOfModels=1, health=28, armor=3, resist=2, attacks=[6]], attackType=["physical"], nodesAttacked=[4], dodge=1, move=[2], attackRange=[1])
Enemy(name="The Pursuer - Cursed Impale (heat up)", expansion="Explorers", enemyType="main boss", numberOfModels=1, health=28, armor=3, resist=2, attacks=[6], attackType=["magic"], dodge=1, move=[1], attackRange=[1])
Enemy(name="The Pursuer - Back Dash (heat up)", expansion="Explorers", enemyType="main boss", numberOfModels=1, health=28, armor=3, resist=2, attacks=[0], attackType=["physical"], dodge=0, move=[-2], attackRange=[2])
Enemy(name="The Pursuer - Forward Dash (heat up)", expansion="Explorers", enemyType="main boss", numberOfModels=1, health=28, armor=3, resist=2, attacks=[0], attackType=["physical"], dodge=0, move=[2], attackRange=[0])
Enemy(name="The Pursuer - Dark Magic (heat up)", expansion="Explorers", enemyType="main boss", numberOfModels=1, health=28, armor=3, resist=2, attacks=[5], attackType=["magic"], nodeAttack=[True], dodge=2, move=[0], attackRange=[4])
Enemy(name="The Pursuer - Shield Bash (heat up)", expansion="Explorers", enemyType="main boss", numberOfModels=1, health=28, armor=3, resist=2, attacks=[5], attackType=["physical"], nodesAttacked=[4], dodge=2, move=[1], attackRange=[1])
Enemy(name="The Pursuer - Shield Smash (heat up)", expansion="Explorers", enemyType="main boss", numberOfModels=1, health=28, armor=3, resist=2, attacks=[7], attackType=["physical"], dodge=1, move=[1], attackRange=[1])
...
Enemy(name="Crossbreed Priscilla - Scything Withdrawal", expansion="Painted World of Ariamis", enemyType="main boss", numberOfModels=1, health=40, armor=2, resist=1, attacks=[5,0], attackType=["physical", "physical"], attackEffect=["bleed", None], nodesAttacked=[10,0], dodge=2, move=[0,-1], attackRange=[1,1])
Enemy(name="Crossbreed Priscilla - Blizzard", expansion="Painted World of Ariamis", enemyType="main boss", numberOfModels=1, health=40, armor=2, resist=1, attacks=[5,0], attackType=["physical", "physical"], nodesAttacked=[14,0], dodge=1, move=[0,1,0,1], attackRange=[2,2])
Enemy(name="Crossbreed Priscilla - Scythe Strike", expansion="Painted World of Ariamis", enemyType="main boss", numberOfModels=1, health=40, armor=2, resist=1, attacks=[5], attackType=["physical"], attackEffect=["bleed"], nodesAttacked=[4], dodge=2, move=[1], attackRange=[1])
...
Enemy(name="Crossbreed Priscilla - Mournful Gaze", expansion="Painted World of Ariamis", enemyType="main boss", numberOfModels=1, health=40, armor=2, resist=1, attacks=[0,3], attackEffect=[None, "frostbite"], attackType=["magic", "magic"], nodesAttacked=[0,14], dodge=3, move=[-2,0], attackRange=[4,4])
...
Enemy(name="Crossbreed Priscilla - Double Lunge", expansion="Painted World of Ariamis", enemyType="main boss", numberOfModels=1, health=40, armor=2, resist=1, attacks=[6,6], attackType=["physical", "physical"], attackEffect=["bleed", "bleed"], nodesAttacked=[4,4], dodge=2, move=[1,1], attackRange=[1,1])
Enemy(name="Crossbreed Priscilla - Double Strike", expansion="Painted World of Ariamis", enemyType="main boss", numberOfModels=1, health=40, armor=2, resist=1, attacks=[6,6,], attackType=["physical", "physical"], attackEffect=["bleed", "bleed"], nodeAttack=[True, True], dodge=2, move=[1,1], attackRange=[1,1])
Enemy(name="Crossbreed Priscilla - Double Slash", expansion="Painted World of Ariamis", enemyType="main boss", numberOfModels=1, health=40, armor=2, resist=1, attacks=[5,5], attackType=["physical", "physical"], attackEffect=["bleed", "bleed"], nodesAttacked=[10], dodge=1, move=[1,1], attackRange=[1,1])
...
Enemy(name="Gravelord Nito - Death Wave", expansion="Tomb of Giants", enemyType="main boss", numberOfModels=1, health=30, armor=2, resist=2, attacks=[5], attackType=["magic"], nodesAttacked=[12], dodge=1, move=[0], attackRange=[1])
Enemy(name="Gravelord Nito - Miasma", expansion="Tomb of Giants", enemyType="main boss", numberOfModels=1, health=30, armor=2, resist=2, attacks=[3], attackType=["magic"], nodesAttacked=[16], dodge=2, move=[0], attackRange=[3])
...
Enemy(name="Gravelord Nito - Entropy", expansion="Tomb of Giants", enemyType="main boss", numberOfModels=1, health=30, armor=2, resist=2, attacks=[4,4], attackType=["physical", "physical"], nodeAttack=[True, True], attackEffect=["poison", "poison"], dodge=1, move=[1,1], attackRange=[1,1])
Enemy(name="Gravelord Nito - Creeping Death", expansion="Tomb of Giants", enemyType="main boss", numberOfModels=1, health=30, armor=2, resist=2, attacks=[5,5,5], attackType=["physical", "physical", "physical"], nodeAttack=[True, True, True], attackEffect=["poison", "poison", "poison"], dodge=1, move=[1,1,1], attackRange=[1,1,1])
Enemy(name="Gravelord Nito - Death's Embrace", expansion="Tomb of Giants", enemyType="main boss", numberOfModels=1, health=30, armor=2, resist=2, attacks=[5], attackType=["physical"], nodeAttack=[True], dodge=2, move=[0], attackRange=[1])
Enemy(name="Gravelord Nito - Lunging Cleave", expansion="Tomb of Giants", enemyType="main boss", numberOfModels=1, health=30, armor=2, resist=2, attacks=[5,5], attackType=["physical", "physical"], attackEffect=["poison", "poison"], nodesAttacked=[4,4], dodge=2, move=[1,1], attackRange=[1,1])
