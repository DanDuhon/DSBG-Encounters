...
# Path attacks hit every node on the way to the target, as well as the target's node.
...
# Nodes attacked
# 0-1 node away: 1.0
# 2 nodes away: 2.764705882352941
# 3 nodes away: 6.666666666666667
# 4 nodes away: 12.0
pathAttacks = ([1.0] * 60) + ([2.764705882352941] * 68) + ([6.666666666666667] * 24) + ([12.0] * 4)
...
class Enemy:
    def __init__(self, name, expansion, enemyType, numberOfModels, health, armor, resist, iconForEffects, attacks, attackType, dodge, move, attackRange, id=None, repeat=0, nodeAttack=[], nodesAttacked=[], attackEffect=[], weakArcs=None, windup=False, moveIndex=None, skipDefense=False, difficultyTiers={}, moveAttack=[], modified=False, comboSet=frozenset(), aoe=False, invisibility=False) -> None:
...
Enemy(id=9, name="Engorged Zombie", expansion="Painted World of Ariamis", enemyType="regular", numberOfModels=2, health=1, armor=2, resist=2, iconForEffects=[0], attacks=[4], attackType=["magic"], dodge=1, move=[1], attackRange=[0], difficultyTiers={1: {"toughness": 17854, "difficulty": {1: 51.96, 2: 51.96, 3: 51.96, 4: 51.96}}, 2: {"toughness": 17195, "difficulty": {1: 11.9, 2: 11.9, 3: 11.9, 4: 11.9}}, 3: {"toughness": 57021, "difficulty": {1: 13.47, 2: 13.47, 3: 13.47, 4: 13.47}}})
Enemy(id=10, name="Falchion Skeleton", expansion="Executioner Chariot", enemyType="regular", numberOfModels=2, health=1, armor=1, resist=1, iconForEffects=[0], attacks=[3], attackType=["physical"], attackEffect=[{"bleed",}], dodge=1, move=[2], attackRange=[0], difficultyTiers={1: {"toughness": 37664, "difficulty": {1: 79.86, 2: 79.86, 3: 79.86, 4: 79.86}}, 2: {"toughness": 42968, "difficulty": {1: 23.11, 2: 23.11, 3: 23.11, 4: 23.11}}, 3: {"toughness": 88396, "difficulty": {1: 63.64, 2: 63.64, 3: 63.64, 4: 63.64}}})
...
Enemy(id=33, name="Stone Knight", expansion="Darkroot", enemyType="regular", numberOfModels=2, health=5, armor=3, resist=2, iconForEffects=[0], attacks=[5], attackType=["magic"], dodge=1, move=[1], attackRange=[0], difficultyTiers={1: {"toughness": 3123, "difficulty": {1: 465.88, 2: 465.88, 3: 465.88, 4: 465.88}}, 2: {"toughness": 2471, "difficulty": {1: 137.13, 2: 137.13, 3: 137.13, 4: 137.13}}, 3: {"toughness": 9691, "difficulty": {1: 161.67, 2: 161.67, 3: 161.67, 4: 161.67}}})
...
# Enemy(id=51, name="Sewer Centipede", expansion="Irithyll of the Boreal Valley", enemyType="regular", numberOfModels=2, health=1, armor=1, resist=1, iconForEffects=[0], attacks=[6], attackType=["physical"], dodge=2, move=[2], attackRange=[0], difficultyTiers={1: {"toughness": 3123, "difficulty": {1: 595.26, 2: 595.26, 3: 595.26, 4: 595.26}}, 2: {"toughness": 2471, "difficulty": {1: 248.18, 2: 248.18, 3: 248.18, 4: 248.18}}, 3: {"toughness": 9691, "difficulty": {1: 256.81, 2: 256.81, 3: 256.81, 4: 256.81}}})
# Enemy(id=52, name="Pontiff Knight", expansion="Irithyll of the Boreal Valley", enemyType="regular", numberOfModels=2, health=3, armor=1, resist=2, iconForEffects=[0,0], attacks=[4,5], attackType=["physical","magic"], dodge=2, move=[2,0], attackRange=[0,1], attackEffect=[{"frostbite",},set()], difficultyTiers={1: {"toughness": 3123, "difficulty": {1: 595.26, 2: 595.26, 3: 595.26, 4: 595.26}}, 2: {"toughness": 2471, "difficulty": {1: 248.18, 2: 248.18, 3: 248.18, 4: 248.18}}, 3: {"toughness": 9691, "difficulty": {1: 256.81, 2: 256.81, 3: 256.81, 4: 256.81}}})
...
# Enemy(id=54, name="Irithyllian Sorcerer Slave", expansion="Irithyll of the Boreal Valley", enemyType="regular", numberOfModels=2, health=1, armor=1, resist=1, iconForEffects=[0], attacks=[4], attackType=["magic"], dodge=1, move=[0], attackRange=[4], invisibility=True, difficultyTiers={1: {"toughness": 3123, "difficulty": {1: 595.26, 2: 595.26, 3: 595.26, 4: 595.26}}, 2: {"toughness": 2471, "difficulty": {1: 248.18, 2: 248.18, 3: 248.18, 4: 248.18}}, 3: {"toughness": 9691, "difficulty": {1: 256.81, 2: 256.81, 3: 256.81, 4: 256.81}}})
...
Enemy(id=38, name="Kirk, Knight of Thorns", expansion="Phantoms", enemyType="invader", numberOfModels=1, health=20, armor=0, resist=0, attacks=[0], attackType=["magic"], iconForEffects=[0], dodge=0, move=[0], attackRange=[0], difficultyTiers={1: {"toughness": 4599, "difficulty": {1: 416.57, 2: 430.66, 3: 444.75, 4: 462.08}}, 2: {"toughness": 6715, "difficulty": {1: 81.22, 2: 84.03, 3: 86.84, 4: 90.31}}, 3: {"toughness": 15341, "difficulty": {1: 199.7, 2: 206.4, 3: 213.1, 4: 221.35}}})
Enemy(id=39, name="Longfinger Kirk", expansion="Phantoms", enemyType="invader", numberOfModels=1, health=20, armor=0, resist=0, attacks=[0], attackType=["magic"], iconForEffects=[0], dodge=0, move=[0], attackRange=[0], difficultyTiers={1: {"toughness": 1455, "difficulty": {1: 3502.85, 2: 3584.84, 3: 3666.82, 4: 3767.73}}, 2: {"toughness": 1919, "difficulty": {1: 761.74, 2: 779.51, 3: 797.27, 4: 819.14}}, 3: {"toughness": 6851, "difficulty": {1: 1394.78, 2: 1424.45, 3: 1454.11, 4: 1490.63}}})
...
Enemy(id=42, name="Marvelous Chester", expansion="Phantoms", enemyType="invader", numberOfModels=1, health=20, armor=0, resist=0, attacks=[0], attackType=["magic"], iconForEffects=[0], dodge=0, move=[0], attackRange=[0], difficultyTiers={1: {"toughness": 1874, "difficulty": {1: 2890.28, 2: 2907.39, 3: 2924.49, 4: 2945.55}}, 2: {"toughness": 3216, "difficulty": {1: 453.92, 2: 456.53, 3: 459.15, 4: 462.37}}, 3: {"toughness": 9666, "difficulty": {1: 912.77, 2: 918.71, 3: 924.65, 4: 931.97}}})
...
Enemy(id=46, name="Xanthous King Jeremiah", expansion="Phantoms", enemyType="invader", numberOfModels=1, health=20, armor=0, resist=0, attacks=[0], attackType=["magic"], iconForEffects=[0], dodge=0, move=[0], attackRange=[0], difficultyTiers={1: {"toughness": 4931, "difficulty": {1: 566.08, 2: 601.98, 3: 637.89, 4: 682.08}}, 2: {"toughness": 7695, "difficulty": {1: 108.34, 2: 115.2, 3: 122.07, 4: 130.53}}, 3: {"toughness": 17992, "difficulty": {1: 201.81, 2: 214.57, 3: 227.32, 4: 243.03}}})
