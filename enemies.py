...
Enemy(name="Standard Invader", expansion=None, numberOfModels=0, health=0, armor=0, resist=0, attacks=[0], attackType=["physical"], dodge=0, move=[0], attackRange=[0], difficulty=0)
Enemy(name="Advanced Invader", expansion=None, numberOfModels=0, health=0, armor=0, resist=0, attacks=[0], attackType=["physical"], dodge=0, move=[0], attackRange=[0], difficulty=0)
