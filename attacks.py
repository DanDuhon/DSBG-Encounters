...
Attack(name="Broadsword", attackNumber=2, damage=[[b,u]], staminaCost=2)
...
Attack(name="Painting Guardian's Curved Sword", attackNumber=1, damage=[[b,b]], bleed=True, staminaCost=0)
Attack(name="Painting Guardian's Curved Sword", attackNumber=2, damage=[[b,b,b]], bleed=True, staminaCost=3)
...
Attack(name="Pike", attackNumber=3, damage=[[b,b,b]], damageMod=1, staminaCost=5, attackRange=1, noRange0=True)
...
Attack(name="Santier's Spear", attackNumber=1, damage=[[u,u]], damageMod=1, staminaCost=1, attackRange=1)
Attack(name="Santier's Spear", attackNumber=2, damage=[[u,u]], staminaCost=3)
