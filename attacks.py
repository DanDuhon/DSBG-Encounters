...
Attack(name="Aged Smelter Sword", attackNumber=1, damage=[[b,b,b,u]], magic=True, staminaCost=2)
Attack(name="Aged Smelter Sword", attackNumber=2, damage=[[u,o,o]], magic=True, staminaCost=5)
Attack(name="Alonne Greatbow", attackNumber=1, damage=[[b,b,b]], staminaCost=2)
Attack(name="Alonne Greatbow", attackNumber=2, damage=[[b,b,u]], staminaCost=4)
Attack(name="Avelyn", attackNumber=1, damage=[[u],[u],[u]], staminaCost=1)
Attack(name="Avelyn", attackNumber=2, damage=[[o],[o],[o]], staminaCost=4)
Attack(name="Balder Side Sword", attackNumber=1, damage=[[u,u]], staminaCost=0)
Attack(name="Balder Side Sword", attackNumber=2, damage=[[o,o]], staminaCost=4)
...
Attack(name="Black Bow of Pharis", attackNumber=1, damage=[[u]], staminaCost=0)
Attack(name="Black Bow of Pharis", attackNumber=2, damage=[[b,u]], staminaCost=2)
Attack(name="Black Bow of Pharis", attackNumber=3, damage=[[b,u]], staminaCost=4)
Attack(name="Black Firebombs", attackNumber=1, damage=[[u,u]], magic=True, staminaCost=4)
...
Attack(name="Black Knight Halberd", attackNumber=1, damage=[[b,b,b]], staminaCost=1)
Attack(name="Black Knight Halberd", attackNumber=2, damage=[[b,b,u]], staminaCost=4)
...
Attack(name="Blinding Bolt", attackNumber=1, damage=[[u],[u],[u],[u],[u]], magic=True, staminaCost=2)
...
Attack(name="Butcher Knife", attackNumber=1, damage=[[b,b]], staminaCost=1)
Attack(name="Butcher Knife", attackNumber=2, damage=[[u,u]], staminaCost=4)
...
Attack(name="Chariot Lance", attackNumber=1, damage=[[o]], bleed=True, staminaCost=0)
Attack(name="Chariot Lance", attackNumber=2, damage=[[u,o]], bleed=True, staminaCost=3)
...
Attack(name="Claymore", attackNumber=1, damage=[[u,u]], damageMod=1, staminaCost=1)
Attack(name="Claymore", attackNumber=2, damage=[[o,o]], damageMod=1, staminaCost=4)
...
Attack(name="Composite Bow", attackNumber=1, damage=[[b,b]], damageMod=-1, staminaCost=0)
Attack(name="Composite Bow", attackNumber=2, damage=[[b,b,b]], damageMod=-1, staminaCost=3)
Attack(name="Crescent Axe", attackNumber=1, damage=[[u]], staminaCost=0)
Attack(name="Crescent Axe", attackNumber=2, damage=[[u,u]], damageMod=1, staminaCost=4)
Attack(name="Crescent Moon Sword", attackNumber=1, damage=[[u]], magic=True, staminaCost=0)
Attack(name="Crescent Moon Sword", attackNumber=2, damage=[[u]], magic=True, staminaCost=3)
Attack(name="Crystal Hail", attackNumber=1, damage=[[b,b]], magic=True, staminaCost=0)
...
Attack(name="Demon's Great Hammer", attackNumber=1, damage=[[u,u]], staminaCost=1)
Attack(name="Demon's Great Hammer", attackNumber=2, damage=[[o,o]], staminaCost=4)
...
Attack(name="Dragon Tooth", attackNumber=1, damage=[[u,o,o]], staminaCost=4)
Attack(name="Dragon Tooth", attackNumber=2, damage=[[u,o,o]], staminaCost=6)
Attack(name="Dragonrider Bow", attackNumber=1, damage=[[o]], staminaCost=1)
Attack(name="Dragonrider Bow", attackNumber=2, damage=[[o]], ignoreDefense=True, staminaCost=4)
Attack(name="Dragonslayer Greatbow", attackNumber=1, damage=[[u,u]], staminaCost=2)
Attack(name="Dragonslayer Greatbow", attackNumber=2, damage=[[u,o]], staminaCost=4)
Attack(name="Dragonslayer Spear", attackNumber=1, damage=[[b,u]], magic=True, staminaCost=0)
Attack(name="Dragonslayer Spear", attackNumber=2, damage=[[b,u,u]], magic=True, staminaCost=4)
Attack(name="Dragonslayer Spear", attackNumber=3, damage=[[u,u]], magic=True, staminaCost=4)
...
Attack(name="Drake Sword", attackNumber=3, damage=[[u,u]], staminaCost=4)
Attack(name="Drakewing Ultra Greatsword", attackNumber=1, damage=[[u,o]], staminaCost=2)
Attack(name="Drakewing Ultra Greatsword", attackNumber=2, damage=[[o,o]], staminaCost=5)
...
Attack(name="Dung Pie", attackNumber=1, poison=True, staminaCost=0)
...
Attack(name="Fire Surge", attackNumber=1, damage=[[u]], magic=True, staminaCost=0)
Attack(name="Fire Surge", attackNumber=2, damage=[[u,u]], magic=True, staminaCost=4)
...
Attack(name="Fireball", attackNumber=1, damage=[[b,b]], magic=True, staminaCost=0)
Attack(name="Fireball", attackNumber=2, damage=[[o,o]], magic=True, staminaCost=5)
Attack(name="Firebombs", attackNumber=1, damage=[[b,b,b]], magic=True, staminaCost=4)
...
Attack(name="Four-Pronged Plow", attackNumber=1, damage=[[u]], staminaCost=1)
Attack(name="Four-Pronged Plow", attackNumber=2, damage=[[u,u]], staminaCost=3)
Attack(name="Fume Ultra Greatsword", attackNumber=1, damage=[[u,o]], staminaCost=2)
Attack(name="Fume Ultra Greatsword", attackNumber=2, damage=[[u,u,o]], staminaCost=5)
Attack(name="Fume Ultra Greatsword", attackNumber=3, damage=[[u,o]], staminaCost=4)
...
Attack(name="Gargoyle's Halberd", attackNumber=1, damage=[[o]], staminaCost=0)
Attack(name="Gargoyle's Halberd", attackNumber=2, damage=[[o,o]], staminaCost=4)
Attack(name="Giant Stone Axe", attackNumber=1, damage=[[b,u]], staminaCost=1)
Attack(name="Giant Stone Axe", attackNumber=2, damage=[[u,o]], staminaCost=4)
Attack(name="Giant's Halberd", attackNumber=1, damage=[[b,u]], staminaCost=1)
Attack(name="Giant's Halberd", attackNumber=2, damage=[[b,o]], staminaCost=4)
...
Attack(name="Golden Ritual Spear", attackNumber=1, damage=[[b,b]], magic=True, staminaCost=0)
Attack(name="Golden Ritual Spear", attackNumber=2, damage=[[u,u]], magic=True, staminaCost=3)
Attack(name="Golden Ritual Spear", attackNumber=3, damage=[[u,u]], magic=True, staminaCost=5)
...
Attack(name="Gotthard Twinswords", attackNumber=3, damage=[[u,u]], staminaCost=3)
...
Attack(name="Gravelord Sword Dance", attackNumber=1, damage=[[b,b]], magic=True, staminaCost=1)
Attack(name="Gravelord Sword Dance", attackNumber=2, damage=[[u,u]], magic=True, staminaCost=3)
...
Attack(name="Great Chaos Fireball", attackNumber=1, damage=[[o]], magic=True, staminaCost=1)
Attack(name="Great Chaos Fireball", attackNumber=2, damage=[[u,u,u]], magic=True, staminaCost=4)
Attack(name="Great Club", attackNumber=1, damage=[[o]], staminaCost=0)
Attack(name="Great Club", attackNumber=2, damage=[[o,o]], staminaCost=3)
Attack(name="Great Combustion", attackNumber=1, damage=[[u]], magic=True, staminaCost=1)
Attack(name="Great Combustion", attackNumber=2, damage=[[o]], magic=True, staminaCost=3)
...
Attack(name="Great Scythe", attackNumber=1, damage=[[b,b,b]], damageMod=-1, staminaCost=1)
Attack(name="Great Scythe", attackNumber=2, damage=[[o,o]], damageMod=-1, staminaCost=4)
...
Attack(name="Halberd", attackNumber=1, damage=[[u]], damageMod=1, staminaCost=1)
Attack(name="Halberd", attackNumber=2, damage=[[u,u]], damageMod=1, staminaCost=4)
...
Attack(name="Homing Crystal Soulmass", attackNumber=1, damage=[[o],[o],[o],[o],[o]], magic=True, staminaCost=5)
Attack(name="Immolation Tinder", attackNumber=1, damage=[[u]], magic=True, staminaCost=0)
Attack(name="Immolation Tinder", attackNumber=2, damage=[[b,b]], magic=True, staminaCost=2)
Attack(name="Immolation Tinder", attackNumber=3, damage=[[b,b]], magic=True, staminaCost=4)
...
Attack(name="Lifehunt Scythe", attackNumber=1, damage=[[u,u]], damageMod=-1, bleed=True, staminaCost=1)
Attack(name="Lifehunt Scythe", attackNumber=2, damage=[[o,o]], damageMod=-1, bleed=True, staminaCost=4)
...
Attack(name="Longbow", attackNumber=1, damage=[[b,b]], staminaCost=0)
Attack(name="Longbow", attackNumber=2, damage=[[b,b,b]], staminaCost=3)
Attack(name="Lothric Knight Greatsword", attackNumber=1, damage=[[b,b]], magic=True, staminaCost=0)
Attack(name="Lothric Knight Greatsword", attackNumber=2, damage=[[b,b,b]], magic=True, staminaCost=3)
...
Attack(name="Moonlight Greatsword", attackNumber=3, damage=[[u,u,u]], magic=True, staminaCost=4)
...
Attack(name="Notched Whip", attackNumber=1, damage=[[u]], bleed=True, staminaCost=0)
Attack(name="Notched Whip", attackNumber=2, damage=[[o]], bleed=True, staminaCost=3)
...
Attack(name="Old Dragonslayer Spear", attackNumber=1, damage=[[b,b]], magic=True, staminaCost=0)
Attack(name="Old Dragonslayer Spear", attackNumber=2, damage=[[b,b,b]], magic=True, staminaCost=3)
Attack(name="Old Dragonslayer Spear", attackNumber=3, damage=[[b,b]], magic=True, staminaCost=3)
...
Attack(name="Onikiri and Ubadachi", attackNumber=3, damage=[[o,o]], staminaCost=4)
...
Attack(name="Partizan", attackNumber=1, damage=[[u,u]], staminaCost=1)
Attack(name="Partizan", attackNumber=2, damage=[[u,u,o]], staminaCost=4)
Attack(name="Pierce Shield", attackNumber=1, damage=[[b,b]], staminaCost=2)
Attack(name="Pike", attackNumber=1, damage=[[b]], damageMod=1, staminaCost=0)
Attack(name="Pike", attackNumber=2, damage=[[b,b]], damageMod=1, staminaCost=3)
Attack(name="Pike", attackNumber=3, damage=[[b,b,b]], damageMod=1, staminaCost=5)
Attack(name="Poison Mist", attackNumber=1, poison=True, staminaCost=1)
Attack(name="Poison Mist", attackNumber=2, poison=True, staminaCost=3)
Attack(name="Poison Throwing Knives", attackNumber=1, damage=[[b,b]], poison=True, staminaCost=3)
...
Attack(name="Pursuer's Ultra Greatsword", attackNumber=1, damage=[[u,u]], staminaCost=2)
Attack(name="Pursuer's Ultra Greatsword", attackNumber=2, damage=[[u,u,o]], staminaCost=5)
Attack(name="Pursuers", attackNumber=1, damage=[[b,b],[b,b],[b,b],[b,b],[b,b]], magic=True, staminaCost=5)
Attack(name="Pyromancy Flame", attackNumber=1, damage=[[b]], magic=True, staminaCost=0)
Attack(name="Pyromancy Flame", attackNumber=2, damage=[[b,b]], magic=True, staminaCost=4)
...
Attack(name="Rotten Ghru Spear", attackNumber=1, damage=[[b,b]], damageMod=-1, poison=True, staminaCost=0)
Attack(name="Rotten Ghru Spear", attackNumber=2, damage=[[b,b]], poison=True, staminaCost=3)
...
Attack(name="Saint Bident", attackNumber=1, damage=[[u,u]], staminaCost=0)
Attack(name="Saint Bident", attackNumber=2, damage=[[b,u,u]], staminaCost=3)
Attack(name="Santier's Spear", attackNumber=1, damage=[[u,u]], damageMod=1, staminaCost=1)
...
Attack(name="Shield Crossbow", attackNumber=1, damage=[[b,b]], staminaCost=0)
Attack(name="Shield Crossbow", attackNumber=2, damage=[[u,u]], staminaCost=4)
Attack(name="Shortbow", attackNumber=1, damage=[[u]], staminaCost=0)
Attack(name="Shortbow", attackNumber=2, damage=[[b,b]], staminaCost=3)
...
Attack(name="Silver Knight Spear", attackNumber=1, damage=[[u]], damageMod=1, staminaCost=0)
Attack(name="Silver Knight Spear", attackNumber=2, damage=[[b,b]], damageMod=1, staminaCost=3)
...
Attack(name="Smelter Sword", attackNumber=1, damage=[[b,b,b]], staminaCost=2)
Attack(name="Smelter Sword", attackNumber=2, damage=[[o,o]], staminaCost=5)
Attack(name="Smough's Hammer", attackNumber=1, damage=[[u,o]], staminaCost=2)
Attack(name="Smough's Hammer", attackNumber=2, damage=[[u,u,o,o]], staminaCost=6)
Attack(name="Sorcerer's Catalyst", attackNumber=1, damage=[[u]], magic=True, staminaCost=1)
Attack(name="Sorcerer's Catalyst", attackNumber=2, damage=[[b,b]], magic=True, staminaCost=3)
Attack(name="Sorcerer's Staff", attackNumber=1, damage=[[u]], staminaCost=0)
Attack(name="Sorcerer's Staff", attackNumber=2, damage=[[u,u]], staminaCost=3)
Attack(name="Sorcerer's Staff", attackNumber=3, damage=[[o]], magic=True, staminaCost=3)
Attack(name="Soul Arrow", attackNumber=1, damage=[[b,b]], magic=True, staminaCost=0)
Attack(name="Soul Arrow", attackNumber=2, damage=[[b,b,b]], magic=True, staminaCost=4)
Attack(name="Soul Greatsword", attackNumber=1, damage=[[b,b]], magic=True, staminaCost=1)
Attack(name="Soul Greatsword", attackNumber=2, damage=[[o,o]], magic=True, staminaCost=3)
Attack(name="Soul Spear", attackNumber=1, damage=[[b]], magic=True, staminaCost=1)
Attack(name="Soul Spear", attackNumber=2, damage=[[b,b,b]], magic=True, staminaCost=4)
Attack(name="Soulstream", attackNumber=1, damage=[[b]], magic=True, staminaCost=0)
Attack(name="Soulstream", attackNumber=2, damage=[[u]], magic=True, staminaCost=2)
Attack(name="Soulstream", attackNumber=3, damage=[[o]], magic=True, staminaCost=4)
Attack(name="Spear", attackNumber=1, damage=[[b]], staminaCost=0)
Attack(name="Spear", attackNumber=2, damage=[[b]], damageMod=1, staminaCost=3)
...
Attack(name="Spitfire Spear", attackNumber=1, damage=[[o]], magic=True, staminaCost=0)
Attack(name="Spitfire Spear", attackNumber=2, damage=[[u,u]], magic=True, staminaCost=4)
Attack(name="Spotted Whip", attackNumber=1, damage=[[b,b]], damageMod=-1, poison=True, staminaCost=0)
Attack(name="Spotted Whip", attackNumber=2, damage=[[b,u]], damageMod=-1, poison=True, staminaCost=3)
Attack(name="Stone Greataxe", attackNumber=1, damage=[[u,u]], staminaCost=2)
Attack(name="Stone Greataxe", attackNumber=2, damage=[[u,u,u]], staminaCost=5)
...
Attack(name="Thorolund Talisman", attackNumber=1, damage=[[b,b]], magic=True, staminaCost=2)
Attack(name="Thorolund Talisman", attackNumber=2, damage=[[u,u]], magic=True, staminaCost=4)
...
Attack(name="Titanite Catch Pole", attackNumber=1, damage=[[b,u]], magic=True, staminaCost=1)
Attack(name="Titanite Catch Pole", attackNumber=2, damage=[[u,u]], magic=True, staminaCost=4)
Attack(name="Titanite Catch Pole", attackNumber=3, damage=[[u,u]], magic=True, staminaCost=4)
...
Attack(name="Vordt's Great Hammer", attackNumber=1, damage=[[u,u,u]], staminaCost=2)
Attack(name="Vordt's Great Hammer", attackNumber=2, damage=[[u,u,u,u]], staminaCost=4)
...
Attack(name="Washing Pole", attackNumber=1, damage=[[b,b]], staminaCost=0)
Attack(name="Washing Pole", attackNumber=2, damage=[[u,u]], staminaCost=2)
Attack(name="Washing Pole", attackNumber=3, damage=[[u,u]], bleed=True, staminaCost=4)
Attack(name="Winged Knight Halberd", attackNumber=1, damage=[[u]], staminaCost=0)
Attack(name="Winged Knight Halberd", attackNumber=2, damage=[[u,u]], staminaCost=3)
Attack(name="Winged Knight Halberd", attackNumber=3, damage=[[u,u]], staminaCost=4)
...
Attack(name="Winged Spear", attackNumber=1, damage=[[b]], damageMod=1, staminaCost=0)
Attack(name="Winged Spear", attackNumber=2, damage=[[b,b]], damageMod=1, staminaCost=3)
Attack(name="Witch's Locks", attackNumber=1, damage=[[u]], magic=True, staminaCost=1)
Attack(name="Witch's Locks", attackNumber=2, damage=[[b,u]], magic=True, staminaCost=4)
Attack(name="Zweihander", attackNumber=1, damage=[[b,u,u]], staminaCost=2)
Attack(name="Zweihander", attackNumber=2, damage=[[b,o,o]], staminaCost=5)
