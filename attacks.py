...
class Attack:
    def __init__(self, name, attackNumber, staminaCost, damage=[[]], damageMod=0, attackRange=0, magic=False, bleed=False, poison=False, ignoreDefense=False, damageBonus=set(), noRange0=False, shiftBefore=0, shiftAfter=0, push=0) -> None:
        if name not in itemTier:
            return
        attacks.append(self)
        self.name = name
        self.attackNumber = attackNumber
        # Uses reachMod to calculate the odds of stamina cost to get into range (1 stamina, 2 stamina, 3 stamina) minus any pre-attack shift.
        freeMoves = 1 + shiftBefore
        self.staminaCost = staminaCost + (freeMoves - reachMod[min([4, attackRange + 1])]) + (freeMoves - reachMod[min([4, attackRange + 2])]) + (freeMoves - reachMod[min([4, attackRange + 3])])
        ...
        self.totalDamage = {}
        weaponRange[name] = max([attackRange + shiftAfter + push, weaponRange.get(name, 0)])
        weaponRangeBoss[name] = max([attackRange + shiftAfter, weaponRange.get(name, 0)])
...
Attack(name="Aural Decoy", attackNumber=1, damage=[], staminaCost=1, attackRange=1, push=1)
Attack(name="Balder Side Sword", attackNumber=1, damage=[[u,u]], staminaCost=0)
Attack(name="Balder Side Sword", attackNumber=2, damage=[[o,o]], staminaCost=4, attackRange=1, shiftBefore=1)
...
Attack(name="Black Firebombs", attackNumber=1, damage=[[u,u]], magic=True, staminaCost=4, attackRange=1, push=1)
...
Attack(name="Black Knight Shield (Deprived)", attackNumber=1, damage=[[u]], staminaCost=2, push=1)
Attack(name="Black Knight Shield (Deprived)", attackNumber=2, damage=[[o]], staminaCost=4, push=1)
...
Attack(name="Blacksteel Katana", attackNumber=1, damage=[[b,b]], staminaCost=1, attackRange=1, shiftBefore=1)
Attack(name="Blacksteel Katana", attackNumber=2, damage=[[b,b,b]], staminaCost=3, attackRange=1, shiftBefore=1)
...
Attack(name="Bountiful Sunlight", attackNumber=1, damage=[], staminaCost=-6)
...
Attack(name="Broadsword", attackNumber=2, damage=[[b,u]], staminaCost=2, attackRange=1, shiftBefore=1)
Attack(name="Broadsword", attackNumber=3, damage=[[u,u]], staminaCost=4, attackRange=1, shiftBefore=1)
...
Attack(name="Carthus Curved Sword", attackNumber=1, damage=[[u,u]], damageMod=-1, staminaCost=1, shiftAfter=1)
Attack(name="Carthus Curved Sword", attackNumber=2, damage=[[u,u,u]], damageMod=-1, staminaCost=3, shiftAfter=1)
...
Attack(name="Dancer's Enchanted Swords", attackNumber=1, damage=[[u], [u]], magic=True, staminaCost=2, attackRange=1, shiftBefore=1)
Attack(name="Dancer's Enchanted Swords", attackNumber=2, damage=[[b,u], [b,u]], magic=True, staminaCost=4, attackRange=1, shiftBefore=1)
Attack(name="Dark Silver Tracer", attackNumber=1, damage=[[u,u]], damageMod=-1, staminaCost=0)
Attack(name="Dark Silver Tracer", attackNumber=2, damage=[[u,u]], damageMod=-1, poison=True, staminaCost=3, shiftAfter=1)
...
Attack(name="Dark Sword", attackNumber=3, damage=[[o,o]], staminaCost=5, attackRange=1, shiftBefore=1)
...
Attack(name="Dragonslayer Greatbow", attackNumber=1, damage=[[u,u]], staminaCost=2, attackRange=3, noRange0=True, push=1)
Attack(name="Dragonslayer Greatbow", attackNumber=2, damage=[[u,o]], staminaCost=4, attackRange=3, noRange0=True, push=1)
...
Attack(name="Dragonslayer's Axe", attackNumber=2, damage=[[u,o]], magic=True, staminaCost=3, attackRange=1, shiftBefore=1)
...
Attack(name="Fire Surge", attackNumber=1, damage=[[u]], magic=True, staminaCost=0, attackRange=2, push=1)
Attack(name="Fire Surge", attackNumber=2, damage=[[u,u]], magic=True, staminaCost=4, attackRange=2, push=1)
...
Attack(name="Firebombs", attackNumber=1, damage=[[b,b,b]], magic=True, staminaCost=4, attackRange=1, push=1)
...
Attack(name="Force", attackNumber=1, damage=[], staminaCost=0, push=1)
Attack(name="Force", attackNumber=2, damage=[], staminaCost=2, push=2)
...
Attack(name="Gold Tracer", attackNumber=2, damage=[[o,o]], damageMod=-1, bleed=True, staminaCost=3, shiftAfter=1)
...
Attack(name="Grass Crest Shield", attackNumber=1, damage=[], staminaCost=-1)
...
Attack(name="Great Chaos Fireball", attackNumber=1, damage=[[o]], magic=True, staminaCost=1, attackRange=2, push=1)
Attack(name="Great Chaos Fireball", attackNumber=2, damage=[[u,u,u]], magic=True, staminaCost=4, attackRange=2, push=1)
...
Attack(name="Heal", attackNumber=1, damage=[], staminaCost=-1)
Attack(name="Heal Aid", attackNumber=1, damage=[], staminaCost=-1)
...
Attack(name="Iron King Hammer", attackNumber=2, damage=[[b,u],[b,u]], staminaCost=4, attackRange=1, shiftBefore=1)
...
Attack(name="Lothric's Holy Sword", attackNumber=1, damage=[[u]], magic=True, staminaCost=-1)
Attack(name="Lothric's Holy Sword", attackNumber=2, damage=[[b,u]], magic=True, staminaCost=2)
Attack(name="Lucerne", attackNumber=1, damage=[[b,b,u]], damageMod=-1, staminaCost=1, shiftAfter=1)
Attack(name="Lucerne", attackNumber=2, damage=[[b,b,b,u]], damageMod=-1, staminaCost=4, shiftAfter=1)
...
Attack(name="Mannikin Claws", attackNumber=1, damage=[[b,b], [b,b]], staminaCost=2, attackRange=1, shiftBefore=1)
Attack(name="Mannikin Claws", attackNumber=2, damage=[[u,u], [u,u]], staminaCost=4, attackRange=1, shiftBefore=1)
...
Attack(name="Murakumo", attackNumber=1, damage=[[b]], staminaCost=0)
Attack(name="Murakumo", attackNumber=2, damage=[[b,b,b]], staminaCost=3)
...
Attack(name="Painting Guardian's Curved Sword", attackNumber=1, damage=[[b,b]], bleed=True, staminaCost=0, attackRange=1, shiftBefore=1, shiftAfter=1)
Attack(name="Painting Guardian's Curved Sword", attackNumber=2, damage=[[b,b,b]], bleed=True, staminaCost=3, attackRange=1, shiftBefore=1, shiftAfter=1)
...
Attack(name="Pike", attackNumber=3, damage=[[b,b,b]], damageMod=1, staminaCost=5, attackRange=2, noRange0=True, shiftBefore=1)
...
Attack(name="Priscilla's Dagger", attackNumber=2, damage=[[o]], bleed=True, staminaCost=3, attackRange=1, shiftBefore=1)
...
Attack(name="Replenishment", attackNumber=1, damage=[], staminaCost=-1)
...
Attack(name="Santier's Spear", attackNumber=2, damage=[[u,u]], staminaCost=3, attackRange=1, shiftBefore=1)
...
Attack(name="Talisman", attackNumber=1, damage=[], staminaCost=-3, attackRange=0)
...
Attack(name="Throwing Knives", attackNumber=1, damage=[[b,b]], staminaCost=1, attackRange=1, shiftBefore=1)
Attack(name="Throwing Knives", attackNumber=2, damage=[[b,b,b]], staminaCost=4, attackRange=1, shiftBefore=1)
...
Attack(name="Titanite Catch Pole", attackNumber=3, damage=[[u,u]], magic=True, staminaCost=4, attackRange=2, noRange0=True, shiftBefore=1)
